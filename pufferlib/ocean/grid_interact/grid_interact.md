...
If the agent reaches the goal first before collecting the reward, all rewards are gone.
If Agent X touches Agent Y, game is over. (Two terminal conditions : Reaching goal or hitting another agent)
...
Whichever agent X or Y (0 or 1 here- could be more than two as well) reaches the goal first after collecting the rewards gets the final reward multiplier of 5.
